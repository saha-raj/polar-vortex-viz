...
export function createJetStreamTrajectory(year, radius = 1.01, opacity = 1, color = 0xffffff, isNormalDay = false) {
    ...
    if (year.startsWith('2010-02')) {
        ...
        const alignedPath = `_output/normal/jetstream_trajectories_ALIGNED_normal_2010_feb/jetstream_traj_${year}_aligned.csv`;
        const originalPath = `_output/normal/jetstream_trajectories_ALIGNED_normal_2010_feb/jetstream_traj_${year}.csv`;
